...
* VANILLA
  * Loading
    ```
    vmdt -e /beegfs/DATA/mobley/limvt/hv1/04_fep/analysis/2_structure/analyzeDCD.tcl -args ../../taut1_18629-19_s211.psf 1 ../../taut1_18629-19_s211.pdb ../../npt01-fwd.dcd
    ```
  * Analysis
    ```
