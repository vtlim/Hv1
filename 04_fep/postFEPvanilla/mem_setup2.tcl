...
# "vmdt file.pdb -e file.tcl > psfgen.out"

set outname taut2_19415-13-c1_e112
...
### Set CHARMM topology files  | GBI / cgenff / hybrid <============ check these
topology /work/cluster/limvt/toppar/cgenff3.0.1/top_all36_cgenff.rtf
...
topology /work/cluster/limvt/toppar/gbi-taut2-chg1.str
